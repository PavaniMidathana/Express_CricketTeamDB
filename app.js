...
const changeFromSnakeCaseToCamelCase = (object) => {
  return {
...
app.get("/players/", async (request, response) => {
  ...
  playersArray = playersArray.map((each) =>
    changeFromSnakeCaseToCamelCase(each)
  );
...
app.get("/players/:playerId/", async (request, response) => {
  ...
  response.send(changeFromSnakeCaseToCamelCase(player));
});
